...
public class Semefinal10 extends JFrame {
    ...
    public Semefinal10(String[] playerNames) {
        this.playerNames = playerNames;
        this.numOfPlayers = playerNames.length;

        // Set frame properties
        setTitle("Semefinal Phase 10");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            Semefinal10 qualificationPhaseFrame = new Semefinal10(playerNames);
