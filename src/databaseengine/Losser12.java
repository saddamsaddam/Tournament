...
public class Losser12 extends JFrame {
    ...
    public Losser12(String[] playerNames) {
        this.playerNames = playerNames;
        this.numOfPlayers = playerNames.length;

        // Set frame properties
        setTitle("Losers Phase 12");
      ...
      // Create labels for each table
        JLabel firstTableLabel = new JLabel("Table: Losers Quarter1");
        JLabel secondTableLabel = new JLabel("Table: Losers Quarter2");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            Losser12 qualificationPhaseFrame = new Losser12(playerNames);
