...
public class LoserWinner12 extends JFrame {
    ...
    public LoserWinner12(String[] playerNames) {
        this.playerNames = playerNames;
        this.numOfPlayers = playerNames.length;

        // Set frame properties
        setTitle("Losers and Winners Phase 12");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            LoserWinner12 qualificationPhaseFrame = new LoserWinner12(playerNames);
