...
public class WinnerGrand12 extends JFrame {
    ...
    public WinnerGrand12(String[] playerNames) {
        this.playerNames = playerNames;
        this.numOfPlayers = playerNames.length;

        // Set frame properties
        setTitle("Winners Phase 12");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            WinnerGrand12 qualificationPhaseFrame = new WinnerGrand12(playerNames);
