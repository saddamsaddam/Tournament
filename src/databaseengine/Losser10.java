...
public class Losser10 extends JFrame {
    ...
    public Losser10(String[] playerNames) {
        this.playerNames = playerNames;
        this.numOfPlayers = playerNames.length;

        // Set frame properties
        setTitle("Losers Phase 10");
      ...
      // Create labels for each table
        JLabel firstTableLabel = new JLabel("Table: Losers Semefinal1");
        JLabel secondTableLabel = new JLabel("Table: Losers Semefinal2");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            Losser10 qualificationPhaseFrame = new Losser10(playerNames);
