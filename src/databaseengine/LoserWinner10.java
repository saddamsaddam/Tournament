...
public class LoserWinner10 extends JFrame {
    ...
    public LoserWinner10(String[] playerNames) {
        this.playerNames = playerNames;
        this.numOfPlayers = playerNames.length;

        // Set frame properties
        setTitle("Losers and Winners Phase 10");
      ...
      // Create labels for each table
        ...
        JLabel secondTableLabel = new JLabel("Table: Winner Final");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            LoserWinner10 qualificationPhaseFrame = new LoserWinner10(playerNames);
